...
<div class="full-height d-flex flex-column align-items-center justify-content-center">
    ...
    <a role="button" class="return-btn btn btn-lg text-light text-center d-flex align-items-center justify-content-center p-3 mt-5" href="/home" data-link>
        <img src="static/assets/UI/icons/back-arrow.svg" alt="return button" id="left-arrow">
    </a>
</div>
EOL
