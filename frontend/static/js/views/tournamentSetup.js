...
// 								<div class="mb-3">
// 									<input type="text" class="form-control" id="tournament-alias" maxlength="12" placeholder="Enter alias">
// 									<div id="tournament-alias-error" class="text-danger mt-1"></div>
// 								</div>
// 							</div>
// 							<div class="modal-footer border-0">
// 								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
// 								<button type="button" class="btn btn-filled" id="save-alias-btn">Save</button>
// 							</div>
// 						</div>
// 					</div>
// 				</div>
...
// 			aliasErrorElem.textContent = 'Alias must be 12 characters or less';
// 			return false;
// 		}
...
// 				document.getElementById('alias-error').textContent = 'Alias must be 12 characters or less';
// 				return false;
// 			}
...
// 				} else {
// 					document.getElementById('alias-error').textContent = 'Error updating alias';
// 				}
// 				return false;
// 			}
...
// 				// Simple validation
// 				if (newAlias.length > 12) {
// 					errorElement.textContent = 'Alias must be 12 characters or less';
// 					return;
// 				}
...
// 					if (!response.ok) {
// 						const data = await response.json();
// 						errorElement.textContent = data.alias ? data.alias[0] : 'Error updating alias';
// 						return;
// 					}
...
// 				} catch (error) {
// 					console.error('Error updating alias:', error);
// 					errorElement.textContent = 'Error updating alias';
// 				}
// 			};
// 		});
// 	}
